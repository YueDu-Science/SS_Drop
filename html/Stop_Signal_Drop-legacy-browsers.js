...
function SS_Prac_Block_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  SS_Prac_Block_Loop.forEach(function() {
...
function SS_Prac_Instr_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  SS_Prac_Instr_Loop.forEach(function() {
...
function SS_Prac_Trial_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  SS_Prac_Trial_Loop.forEach(function() {
...
function SS_Block_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  SS_Block_Loop.forEach(function() {
...
function Show_Instr_BoolLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  Show_Instr_Bool.forEach(function() {
...
function SS_Instr_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  SS_Instr_Loop.forEach(function() {
...
function SS_Trial_LoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  SS_Trial_Loop.forEach(function() {
...
function InitiationRoutineBegin(trials) {
  return function () {
    ...
    InitiationComponents.forEach( function(thisComponent) {
...
function SS_Prac_Instr_Load_InfoRoutineBegin(trials) {
  return function () {
    ...
    SS_Prac_Instr_Load_InfoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_Instr_PreTrialRoutineBegin(trials) {
  return function () {
    ...
    SS_Instr_PreTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_Instr_MainTrialRoutineBegin(trials) {
  return function () {
    ...
    SS_Instr_MainTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_Prac_CountDownRoutineBegin(trials) {
  return function () {
    ...
    SS_Prac_CountDownComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_Prac_PreTrialRoutineBegin(trials) {
  return function () {
    ...
    SS_Prac_PreTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_Prac_MainTrialRoutineBegin(trials) {
  return function () {
    ...
    SS_Prac_MainTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_Prac_PostTrialRoutineBegin(trials) {
  return function () {
    ...
    SS_Prac_PostTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function Instr_SSRoutineBegin(trials) {
  return function () {
    ...
    Instr_SSComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_Instr_Load_InfoRoutineBegin(trials) {
  return function () {
    ...
    SS_Instr_Load_InfoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_CountDownRoutineBegin(trials) {
  return function () {
    ...
    SS_CountDownComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_PreTrialRoutineBegin(trials) {
  return function () {
    ...
    SS_PreTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_MainTrialRoutineBegin(trials) {
  return function () {
    ...
    SS_MainTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SS_PostTrialRoutineBegin(trials) {
  return function () {
    ...
    SS_PostTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
